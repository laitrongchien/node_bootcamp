    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _stripeJs.loadStripe)('pk_test_51NiCykEaPOrM59FlrY5BNiJjbHR7mWlnCMtZYGbqg7X19BfDK9sGdipLy6J0a07Isae7bDS2jP9f3nj8F25qutEV00X7ZfxG22');
        ...
        case 6:
          ...
          console.log(session.data.session.id); // 2) Create checkout form + chanre credit card
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js"}],"review.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(tourId, rating, review) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Create a review successfully!');
          }
...
if (reviewBtn) {
  reviewBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var tourId = e.target.dataset.tourId;
    var starInputs = document.querySelectorAll('input[type="radio"]');
    var rating = null;
